...
#include <optional>
//error handeling because inspect is blocked on school devices
//so i need this to veiw errors.
#ifdef __EMSCRIPTEN__
#include <emscripten.h>
void ShowWebError(const char* errorMessage) {
    EM_ASM({
        alert("C++ Game Crash Log: " + UTF8ToString($0));
    }, errorMessage);
}
#endif
